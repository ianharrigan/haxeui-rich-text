...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("", "haxeuirichtext", "haxe.ui.richtext.haxeuirichtext", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("haxe.ui.richtext.Main");
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (haxe.ui.richtext.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (haxe.ui.richtext.Main, Reflect.field (haxe.ui.richtext.Main, "main"), []);
...
@:keep class DocumentClass extends haxe.ui.richtext.Main { }
